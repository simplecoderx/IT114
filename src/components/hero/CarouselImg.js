...
const CarouselImg = () => {
  return (
    <div
      id="hero-carousel"
      className="carousel slide carousel-space"
      ...
      <div className="carousel-inner">
        <div className="carousel-item active c-item">
          ...
          <div className="carousel-caption animated">
            <p className=" text-uppercase fs-3 mt-5  smallTxt">Cleaning</p>
            <h1 className="display-1 fw-bolder text-capitalize bannerCaption">
              Introducing the Best Cleaning Services
            </h1>
            <h5 className="text-focus-in">
              Ensuring the overall health and safety of individuals and the
              community.
            </h5>
        ...
        <div className="carousel-item c-item">
          ...
          <div className="carousel-caption animated">
            ...
            <h5 className="text-focus-in">
              Cleaning through sanitizing were you can help keep your house
        ...
        <div className="carousel-item c-item">
          ...
          <div className="carousel-caption animated">
            <p className=" text-uppercase fs-3 mt-5  smallTxt">Polishing</p>
            <h1 className="display-1 fw-bolder text-capitalize bannerCaption">
              Delivering Our Accurate Work Just In Time!
            </h1>
            <h5 className="text-focus-in">
              Right tools and cleaning methods, prioritizing tasks, and ensuring
              properly trained and supervised staff.
            </h5>
            <div class="btn-container">
              <a href="#plans">
                <button
                  className="btn px-4 py-2 fs-5 mt-5 carouselBtn"
                >
                  Start Now
                </button>
              </a>
